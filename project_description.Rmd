...
3) It may be interesting if departure delay time differs from arrival. The average time is taken as an input and the following rwo plots were produced to observe the data.
